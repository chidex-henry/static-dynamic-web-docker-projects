...
3. **Built and Pushed Docker Image to ECR:**
   - Built and pushed the Docker image from an AWS EC2 Instance to AWS ECR using the following steps:
    ...
    -  AWS configuration
	      ...
	      Launched an Amazon EC2 instance in the private subnet and an EC2 instance connect endpoint. This EC2 Instance connect endpoint was used to SSH into the           Amazon EC2 instance in the private subnet
